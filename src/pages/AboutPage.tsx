                ...
                <div className="relative flex flex-col items-center text-center z-10 w-full">
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        <defs>
                          <path id="otw-circle-about" d="M 65,65 m -50,0 a 50,50 0 1,1 100,0 a 50,50 0 1,1 -100,0" />
                        </defs>
                        <text fill="#ffffff" fontSize="8.5" letterSpacing="2.2" fontWeight={600} className="select-none">
                          <textPath href="#otw-circle-about" startOffset="0%">OPEN TO WORK • OPEN TO WORK • </textPath>
                        </text>
                      </motion.svg>
