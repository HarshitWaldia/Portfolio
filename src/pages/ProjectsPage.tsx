                    ...
                    {filteredProjects.map((project, idx) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className={`group/card relative flex flex-col justify-between rounded-2xl border border-white/[0.08] bg-[#0c0c0f] hover:bg-[#111116] ${theme.glow} p-6 transition-colors duration-300 shadow-xl overflow-hidden`}
                        >
